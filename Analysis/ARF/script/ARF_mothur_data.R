...
write.csv(data.frame(metadata_1b_sp16) , here("SelectMicro_24new/Analysis/ARF/data/ARF_SP_16S_metadata.csv"),row.names = TRUE)
...
write.csv(bact_OTU_sp_n_df, here("SelectMicro_24new/Analysis/ARF/data/ARF_SP_16S_OTUtable.csv"),row.names = TRUE)
write.csv(bact.sp_OTU_tax_table, here("SelectMicro_24new/Analysis/ARF/data/ARF_SP_16S_taxtable.csv"),row.names = TRUE) 
...
write.csv(bact_class_sp_n_df, here("SelectMicro_24new/Analysis/ARF/data/ARF_SP_16S_Classtable.csv"),row.names = TRUE)
write.csv(bact_phylum_sp_n_df, here("SelectMicro_24new/Analysis/ARF/data/ARF_SP_16S_Phylumtable.csv"),row.names = TRUE)
...
metadata_1b_win16 <- metadata_1b_win16 %>% select(-"X")
# Response variable: define the Phase based on values in Study_day and pass it to the metadata
...
write.csv(data.frame(metadata_1b_win16) , here("SelectMicro_24new/Analysis/ARF/data/ARF_WIN_16S_metadata.csv"),row.names = TRUE)
...
write.csv(bact_OTU_win_n_df, here("SelectMicro_24new/Analysis/ARF/data/ARF_WIN_16S_OTUtable.csv"),row.names = TRUE)
write.csv(bact.win_OTU_tax_table, here("SelectMicro_24new/Analysis/ARF/data/ARF_WIN_16S_taxtable.csv"),row.names = TRUE) 
...
colnames(bact_OTU_win_n_df)
colnames(bact_class_win_n_df)
colnames(bact_phylum_win_n_df)

write.csv(bact_class_win_n_df, here("SelectMicro_24new/Analysis/ARF/data/ARF_WIN_16S_Classtable.csv"),row.names = TRUE)
write.csv(bact_phylum_win_n_df, here("SelectMicro_24new/Analysis/ARF/data/ARF_WIN_16S_Phylumtable.csv"),row.names = TRUE)
...
row.names(bact_class_win_n_df)
row.names(bact_OTU_win_n_df)
