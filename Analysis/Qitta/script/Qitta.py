...
"""
print("Update lasso function to classification-----------------------------------------")
tax_levels = ['genus', 'species']

print("do not use npy data-----------------------------------------")
total_features_species = np.load('SelectMicro_24/Analysis/Qitta/data/final_combine/total_features_species.npy')
total_features_genus = np.load('SelectMicro_24/Analysis/Qitta/data/final_combine/total_features_genus.npy')
data_list = [total_features_species,total_features_genus]

y= np.load('SelectMicro_24/Analysis/Qitta/data/final_combine/total_label.npy')
le = LabelEncoder()
...
for index, tax_level in enumerate(tax_levels):
    ...
    dict_cm_list = []
    save_dir = "/lustre/isaac24/scratch/mhe8/SelectMicro_24/Analysis/Qitta/results/plots_combine"
    for datatype, subset in data_subset.items():
        ...
        metric.plot_multiclass_roc_cv(dict_cm['y_true'], dict_cm['y_pred_prob'], class_index=1, n_classes=2, class_label='IBD',save_path=os.path.join(save_dir, f"RF_{datatype}_ROC_binary.png"))
    ...
    for datatype, subset in data_subset.items():
        ...
        dict_cm_list.append(dict_cm)
        metric.plot_multiclass_roc_cv(dict_cm['y_true'], dict_cm['y_pred_prob'], class_index=1, n_classes=2, class_label='IBD',save_path=os.path.join(save_dir, f"XG_{datatype}_ROC_binary.png"))
    ...
    for datatype, subset in data_subset.items():
        ...
        dict_cm = RunModel.NB_model_SCV_multi(subset, target_variable,SMOTE=True,k=5)
        dict_cm_list.append(dict_cm)
        metric.plot_multiclass_roc_cv(dict_cm['y_true'], dict_cm['y_pred_prob'], class_index=1, n_classes=2, class_label='IBD',save_path=os.path.join(save_dir, f"NB_{datatype}_ROC_binary.png"))
        #metric.plot_SHAP_multiclass(dict_cm['SHAP_full'],dict_cm['x_true'],class_index=1, save_path=os.path.join(save_dir, f"XG_{datatype}_SHAP_binary.png"))
    ...
    for datatype, subset in data_subset.items():
        ...
        dict_cm = RunModel.SVM_model_SCV_multi(subset, target_variable,SMOTE=True,k=5)
        dict_cm_list.append(dict_cm)
        metric.plot_multiclass_roc_cv(dict_cm['y_true'], dict_cm['y_pred_prob'], class_index=1, n_classes=2, class_label='IBD',save_path=os.path.join(save_dir, f"SVM_{datatype}_ROC_binary.png"))
        #metric.plot_SHAP_multiclass(dict_cm['SHAP_full'],dict_cm['x_true'],class_index=1, save_path=os.path.join(save_dir, f"XG_{datatype}_SHAP_binary.png"))
"""
# Model-----------------------------------------------------------
print("5 fold cross validation using Random forest model -----------------------------------------")
...
for datatype, subset in data_subset.items():
    ...
    #dict_cm = RunModel.NB_model_SCV_multi(subset, target_variable,SMOTE=True,k=5)
    dict_cm_list.append(dict_cm)
    metric.plot_multiclass_roc_cv(dict_cm['y_true'], dict_cm['y_pred_prob'], class_index=1, n_classes=3, class_label='Class 1',save_path=os.path.join(save_dir, f"XG_{datatype}_ROC_class1.png"))
    ...
    metric.plot_multiclass_roc_cv(dict_cm['y_true'], dict_cm['y_pred_prob'], class_index=2, n_classes=3, class_label='Class 2',save_path =os.path.join(save_dir, f"XG_{datatype}_ROC_class2.png"))
